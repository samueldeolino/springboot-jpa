...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order order1 = new Order(null, Instant.parse("2025-04-14T10:06:20Z"), user1);
        Order order2 = new Order(null, Instant.parse("2025-04-06T11:32:20Z"), user2);
        Order order3 = new Order(null, Instant.parse("2025-04-10T10:06:20Z"), user1);
